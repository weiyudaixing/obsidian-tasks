 ...
 * The values are: symbol, name, next symbol, status stage (must be one of the values in {@link StatusStage}
 */
export type StatusCollectionEntry = [string, string, string, string, string];
